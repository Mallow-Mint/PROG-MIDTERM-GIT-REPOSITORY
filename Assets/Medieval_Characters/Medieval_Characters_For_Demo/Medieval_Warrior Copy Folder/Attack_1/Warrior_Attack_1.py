...
sprite_frames = [
    pygame.image.load('warrior_normal_attack_1.png'),
    pygame.image.load('warrior_normal_attack_2.png'),
    pygame.image.load('warrior_normal_attack_3.png'),
    pygame.image.load('warrior_normal_attack_4.png')
]
