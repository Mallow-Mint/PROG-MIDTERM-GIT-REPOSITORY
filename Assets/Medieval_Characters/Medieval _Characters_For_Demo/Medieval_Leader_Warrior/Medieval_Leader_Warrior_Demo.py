...
def load_sprites():
    try:
        ...
        sprite_animations = {
            ...
            "death": [
                pygame.image.load('Assets/Medieval_Characters/Medieval_Characters_For_Demo/Medieval_Leader_Warrior/Death/Medieval_Leader_Warrior_Death_1.png').convert_alpha(),
...
player = Character(name="Leader_Warrior", hp=100, sprite_animations=sprite_animations)
