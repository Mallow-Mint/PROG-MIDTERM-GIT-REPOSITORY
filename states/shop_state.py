...
Health_Pot_Sprite = General_Spritesheet(sprite_sheet_HpS, 285, 38, 15, 3, 75, shop_layer)
Health_Pot_XL_Sprite = General_Spritesheet(sprite_sheet_HpXL, 432, 34, 24, 3, 75, shop_layer)
All_Letter_Potion_Sprite = General_Spritesheet(sprite_sheet_ALpotion, 288, 39, 12, 3, 75, shop_layer)
Letter_Potion_Sprite = General_Spritesheet(sprite_sheet_Lpotion, 396, 35, 22, 3, 75, shop_layer)
ribit_sprite = General_Spritesheet(ribit_sheet, 432, 16, 27, 4, 75, sprite_layer)
