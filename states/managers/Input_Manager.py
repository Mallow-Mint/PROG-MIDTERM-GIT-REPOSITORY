...
class Spell:
    def __init__(self):
        ...
        self.spell_animation_layer = pygame.Surface((1600,900))
...
#Single Target Spells - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
            case self.current_spell if self.current_spell in spell_dict.single_target_words_damage.keys():
                ...
                self.spell_animation = spell_animations.get_spell_sprite_sheet(self.current_spell)
...
spell = Spell()
spell_animations = Spell_Animations(spell.spell_animation_layer)
damage = Damage()