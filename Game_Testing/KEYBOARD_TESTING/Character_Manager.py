    ...
    def enemy_initalizer(self, enemy_count:int):
        for x in range(enemy_count):
            if x == 0:
                ...
                pygame.draw.rect(self.enemy_layer, self.mobs_list[character.enemy_color(self.enemy_1)], (900, 200, 100, 200))
            elif x == 1:
                self.enemy_2 = character.random_enemy_type()
                pygame.draw.rect(self.enemy_layer, self.mobs_list[character.enemy_color(self.enemy_2)], (1050, 150, 100, 200))
            elif x == 2:
                self.enemy_3 = character.random_enemy_type()
                pygame.draw.rect(self.enemy_layer, self.mobs_list[character.enemy_color(self.enemy_3)], (1200, 200, 100, 200))
            elif x == 3:                
                self.enemy_4 = character.random_enemy_type()
                pygame.draw.rect(self.enemy_layer, self.mobs_list[character.enemy_color(self.enemy_4)], (1350, 150, 100, 200))
