...
sprite_sheet_HpS = get_image('Game_Testing/SHOP TESTING/Assets/Healing potion OG.png', 3)
Health_Pot_Sprite = Spritesheet(sprite_sheet_HpS, 19, 38, 15, 3)
Health_Pot_Sprite.get_potion_frames()

class Layers:
    def __init__(self):
        self.potion_layer = potion_layer_test
...
layers = Layers()
layers.potion_layer.fill((255, 255, 0))
layers.potion_layer.set_colorkey((255,255,0))

def update_screen():
    screen.blit(screen, (0,0))
    screen.blit(layers.potion_layer, (0,0))
    pygame.display.flip()
...
def main():
    ...
    while running:
        ...
        Health_Pot_Sprite.display_potion()
